    ...
    public void addRecipes(RecipeGroup<RecipeEntryCrafting<?, ?>> group) {
        group.register(
            ...
            new RecipeEntryCraftingGroup(
                ...
                new RecipeSymbol[] {
                    ...
                    new RecipeSymbol(Block.glass.getDefaultStack())
                },
                ...
                (inventoryCrafting, stackSize) -> {
                    ...
                    for (int index = 0; index < 9; index++) {
                        ItemStack inputStack = inventoryCrafting.getStackInSlot(index);
                        if (inputStack == null)
                            continue;
        ...
        group.register(
            ...
            new RecipeEntryCraftingGroup(
                ...
                smallWindow,
                (inventoryCrafting, stackSize) -> {
                    ItemStack inputPlank1 = inventoryCrafting.getStackInSlot(0);
                    ItemStack inputPlank2 = inventoryCrafting.getStackInSlot(2);
                    ItemStack window = NFCBlocks.window.getDefaultStack();

                    for (int index = 0; index < 9; index++) {
                        ItemStack inputStack = inventoryCrafting.getStackInSlot(index);
                        ItemStack inputStack2 = inventoryCrafting.getStackInSlot(index + 2);
        ...
        group.register(
            ...
            new RecipeEntryCraftingGroup(
                ...
                miniWindow,
                (inventoryCrafting, stackSize) -> {
                    ItemStack inputPlank = inventoryCrafting.getStackInSlot(0);
                    ItemStack window = NFCBlocks.window.getDefaultStack();
                    ...
                    for (int index = 1; index < 9; index++) {
                        if (index == 4)
                            continue;
                        allSameColor &= inputPlank.getMetadata() == inventoryCrafting.getStackInSlot(index).getMetadata();
                        allSameBlock &= inputPlank.itemID == inventoryCrafting.getStackInSlot(index).itemID;
                    }
        ...
        group.register(
            ...
            new RecipeEntryCraftingGroup(
                ...
                quadrupleWindow,
                (inventoryCrafting, stackSize) -> {
                    ItemStack inputPlank = inventoryCrafting.getStackInSlot(1);
                    ItemStack window = NFCBlocks.window.getDefaultStack();
